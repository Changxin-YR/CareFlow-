...
DOMAIN_KEYWORDS: dict[str, tuple[str, ...]] = {
    ...
    "KB_PRIMARYCARE": (
        "家庭医生", "签约", "随访", "转诊", "健康档案", "建档",
        # 注意：「基层」单独出现**不算**这个域的关键词 —— 它是泛用限定词
        # （基层慢病、基层随访、基层非传染性疾病管理… 都可能只是修饰语）。
        # 必须是更具体的组合词，否则会把中文基层文档拉进 WHO/国际问题里。
        "基层医疗卫生机构", "基层医疗", "基层卫生", "社区卫生", "乡镇卫生院",
        "村卫生室", "基本公共卫生", "老年人健康", "老年健康", "老年综合评估",
        "免费体检", "慢病管理服务", "分级诊疗", "管理率", "规范化管理",
    ),
    "KB_CORE": (
